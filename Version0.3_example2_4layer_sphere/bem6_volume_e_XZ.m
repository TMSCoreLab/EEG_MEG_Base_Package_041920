...
%%  Load/prepare data
planeABCD = [0 1 0 -Y*1e-3]; %Analytical equation of the observation point plane for neighbor search acceleration
...
[Epri(in, :), ~]= bemf3_inc_field_electric(strdipolePplus,...
                                        ...
                                        P, t, pointsXZ(in, :), Area, normals, 0, 0);   
...
th2 = 0;            %   in A/m^2
levels      = 20;
bemf2_graphics_vol_field(temp, th1, th2, levels, x, z); hold on;
xlabel('Distance x, mm');
ylabel('Distance z, mm');
