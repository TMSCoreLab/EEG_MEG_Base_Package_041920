...
iter         = 15;              %    Maximum possible number of iterations in the solution 
relres       = 1e-4;            %    Minimum acceptable relative residual 
...
gaussRadius = 6*R; % Incident fields at triangles within gaussRadius of the center of the dipole cluster will be evaluated using Gaussian subdivision
