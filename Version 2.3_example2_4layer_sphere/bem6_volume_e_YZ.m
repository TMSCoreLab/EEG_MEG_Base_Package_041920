...
%%  Load/prepare data
planeABCD = [1 0 0 -X*1e-3]; %Analytical equation of the observation point plane for neighbor search acceleration
...
[Epri(in, :), ~]= bemf3_inc_field_electric(strdipolePplus,...
                                        ...
                                        P, t, pointsYZ(in, :), Area, normals, 0, 0);      
